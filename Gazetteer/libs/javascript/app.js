...
function getCountry() {
  $.ajax({
    url: '/Users/harmelikyan/.bitnami/stackman/machines/xampp/volumes/root/htdocs/gazetteer Right structer/libs/php/getCountriesCode.php',
    type: 'GET',
    dataType: 'json',
  ...
  if (navigator.geolocation) {
    navigator.geolocation.getCurrentPosition(
      function (position) {
        ...
        $.ajax({
          url: "libs/php/getLatLong.php?lat=" +
            latitude +
            "&lng=" +
            longitude +
...
function getNearbyCities(east, west, north, south) {
  ...
  $.ajax({
    url: "libs/php/getCitiesNearby.php",
    type: "GET",
    data: {
      east: east,
      west: west,
...
function getCountryInfo(countryCode) {
  $.ajax({
    url: "/Users/harmelikyan/.bitnami/stackman/machines/xampp/volumes/root/htdocs/gazetteer Right structer/libs/php/getCountryInfo.php",
    type: "GET",
    datatype: 'json',
    data: {
      countryCodeGlobal: countryCode
...
function getNationalHoliday(alpha2Code) {
  $.ajax({
    url: "libs/php/getNationalHoliday.php",
    type: "GET",
    datatype: "json",
    data: {
